...
-- -----------------------------------------------------
-- Data for table `anidb`.`HDD`
-- -----------------------------------------------------
START TRANSACTION;
USE `anidb`;
INSERT INTO `anidb`.`HDD` (`id`, `from`, `to`, `hddSize`) VALUES (1, 'j', 'q', 1000169533440);
INSERT INTO `anidb`.`HDD` (`id`, `from`, `to`, `hddSize`) VALUES (2, 'r', 'z', 1000169533440);
